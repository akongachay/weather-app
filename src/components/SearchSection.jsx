const SearchSection = ({ getWeatherDetails, searchInputRef }) => {
  ...
  return (
    ...
    <span className="material-symbols-outlined">search</span>        <input type="search" placeholder="Enter a city name" className="search-input" ref={searchInputRef} required />
      </form>
